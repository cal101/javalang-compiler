...
public class AnonymousClassUtil {
    ...
    /**
     * For anonymous creations the initial symbol data is symbol data of super class. That needs to
     * be replaced with symbol data of anonymous class. If we don't have symbol data we assume we
     * need one. ;-)
     */
