...
/**
 * Provides a way to setup a set of SymbolAction for every type of symbol (method, variable, type,
 * field, enum, annotations), the global scope (compilation unit) and an specific scope(BlockStmt)
 *
 * @author rpau
 */
